...
class NotificationActionsView(APIView):
    ...
    def post(self, request, pk):
        try:
            notification = SystemNotification.objects.get(pk=pk, recipient=request.user)
...
class NotificationBulkActionsView(APIView):
    ...
    def post(self, request):
        ...
        queryset = SystemNotification.objects.filter(recipient=request.user)
...
class NotificationStatsView(APIView):
    ...
    def get(self, request):
        user_notifications = SystemNotification.objects.filter(recipient=request.user)
