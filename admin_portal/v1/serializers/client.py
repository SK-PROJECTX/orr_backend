...
from admin_portal.models import Client, ClientDocument, Ticket, Meeting
...
class ClientListSerializer(serializers.ModelSerializer):
    ...
    assigned_admin_name = serializers.CharField(source='assigned_admin.get_full_name', allow_null=True)
    
    class Meta:
        model = Client
        fields = [
            'id', 'full_name', 'email', 'company', 'role', 'stage', 
            'primary_pillar', 'assigned_admin_name', 'is_portal_active', 
...
class ClientDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Client
        fields = [
            'id', 'full_name', 'email', 'username', 'company', 'role', 
            'stage', 'primary_pillar', 'secondary_pillars', 'assigned_admin_name',
            'internal_notes', 'is_portal_active', 'last_activity', 
            'date_joined', 'last_login', 'created_at', 'updated_at',
            'tickets_count', 'meetings_count', 'documents_count'
        ]
...
class ClientUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Client
        fields = [
            'company', 'role', 'stage', 'primary_pillar', 'secondary_pillars',
            'assigned_admin', 'internal_notes', 'is_portal_active'
        ]
...
class ClientDocumentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'title', 'description', 'document', 'document_type',
            'is_visible_to_client', 'uploaded_by_name', 'download_count',
            'last_accessed', 'created_at', 'file_size'
        ]
