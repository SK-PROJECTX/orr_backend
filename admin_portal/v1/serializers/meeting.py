...
class MeetingListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Meeting
        fields = [
            'id', 'client_name', 'client_company', 'meeting_type', 'status',
            'requested_datetime', 'confirmed_datetime', 'duration_minutes',
...
class MeetingDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'meeting_type', 'status', 'requested_datetime', 'confirmed_datetime',
            'duration_minutes', 'agenda', 'meeting_notes', 'internal_notes',
            'host_name', 'calendar_event_id', 'meeting_link', 'created_at', 'updated_at'
        ]
...
class MeetingUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Meeting
        fields = [
            'status', 'confirmed_datetime', 'duration_minutes', 'host',
            'meeting_notes', 'internal_notes', 'meeting_link'
        ]


class MeetingActionSerializer(serializers.Serializer):
    """Meeting action serializer"""
    action = serializers.ChoiceField(choices=['confirm', 'reschedule', 'decline', 'complete', 'cancel'])
