...
class SystemSettingsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'company_name', 'logo', 'primary_color', 'contact_email',
            'contact_phone', 'default_meeting_duration', 'meeting_buffer_time',
            'business_hours_start', 'business_hours_end', 'email_notifications_enabled',
            'notification_email', 'privacy_policy_url', 'terms_of_service_url',
...
class AdminRoleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AdminRole
        fields = [
            'id', 'name', 'description', 'can_manage_users', 'can_view_all_clients',
            'can_edit_clients', 'can_manage_tickets', 'can_manage_meetings',
            'can_create_content', 'can_publish_content', 'can_view_analytics',
            'can_view_billing', 'can_manage_settings', 'can_view_ai_logs',
            'users_count'
        ]
...
class AdminProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'role', 'role_name', 'department', 'phone', 'is_active',
            'last_login_ip', 'last_login', 'date_joined', 'created_at', 'updated_at'
        ]
...
class AuditLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AuditLog
        fields = [
            'id', 'username', 'user_full_name', 'action', 'model_name',
