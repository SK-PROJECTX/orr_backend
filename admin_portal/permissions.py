...
class CanManageUsers(BasePermission):
    ...
    def has_permission(self, request, view):
        if not (
            request.user.is_authenticated and hasattr(request.user, "admin_profile")
        ):
            return False
...
class CanManageTickets(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return (
            role.name in ["super_admin", "admin", "operator"]
            and role.can_manage_tickets
        )
...
class CanCreateContent(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return (
            role.name in ["super_admin", "admin", "content_editor"]
            and role.can_create_content
        )
...
class CanPublishContent(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return (
            role.name in ["super_admin", "content_editor"] and role.can_publish_content
        )
