...
class Client(Audit):
    ...
    # Admin fields
    assigned_admin = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='assigned_clients')
...
class Ticket(Audit):
    ...
    source = models.CharField(max_length=20, choices=SOURCE_CHOICES, default='manual_request')
    ...
    related_content = models.ForeignKey('Content', on_delete=models.SET_NULL, null=True, blank=True)
...
class Content(Audit):
    ...
    # Files
    attachment = models.FileField(upload_to='content_attachments/', blank=True, null=True)
...
class AIConversation(Audit):
    ...
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='ai_conversations')
