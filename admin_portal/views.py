...
def sync_howweoperate_it_view(request):
    """
    Temporary view to trigger Italian translation sync.
    Visit: /admin-portal/v1/cms/sync-it-translations-secret/
    """
    try:
        # 1. Page Content
        page_it = {
        ...
        return JsonResponse({"success": True, "message": "Italian translations synced successfully!"})
