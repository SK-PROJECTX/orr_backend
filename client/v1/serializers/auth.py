...
class SignUpSerializer(serializers.ModelSerializer):
    ...
    user_type = serializers.ChoiceField(choices=[('client', 'Client'), ('admin', 'Admin')], default='client')
    ...
    class Meta:
        model = User
        fields = ("username", "email", "password", "first_name", "last_name", "user_type", "admin_role")
